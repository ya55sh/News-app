...
class General extends React.Component {
  constructor(props) {
    ...
    this.state = {
      loading: true,
      content: null,
      countryCode: props.countryCode? props.countryCode:paramValue,
      clickstate: false
    };
  }

  async componentDidMount() {
    const url = `https://newsapi.org/v2/top-headlines?category=general&country=${this.state.countryCode}&apiKey=675ad4a2820d4c4b9e8a95547e84a0b2&pageSize=100`;
  ...
  handleClick(item) {
    this.setState({ item: item, showGNC: true, clickstate: true });
  }
